          ...
          <div className="flex flex-col md:flex-row md:justify-between">
            ...
            <div className="md:w-1/2">
              <div className="space-y-6 text-white">
                <p className="text-xl">
                  <span className="font-bold">13/06</span> – Data limite de
                  submissão dos trabalhos
                </p>
                <p className="text-xl">
                  <span className="font-bold">12/08</span> – Divulgação dos
                  trabalhos aceitos
                </p>
                <p className="text-xl">
                  <span className="font-bold">14/08</span> – Data limite de
                  inscrição dos trabalhos
                </p>
                <p className="text-xl font-bold">26 e 27/08/2025 – EMPRAD</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              Explore a nossa ferramenta de IA que ajuda a encontrar informações
              em todos os artigos do EMPRAD.
            </p>
            <Link
              to="/research-assistant"
              className="text-blue-600 font-medium hover:underline inline-flex items-center"
