      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Explore todos os artigos publicados no EMPRAD
          </p>
        </div>
              ...
              {filteredArticles.length > 0 ? (
                <div className="space-y-4 mb-4">
                  {filteredArticles.map((article) => (
                    ...
                    >
                      <h3 className="font-medium text-emprad-dark-purple">
                        {article.title}
                      </h3>
            ...
            <Tabs defaultValue="alphabetical">
              ...
              <TabsContent value="alphabetical" className="pt-4">
                ...
                <div className="space-y-6">
                  {Object.entries(articlesByLetter)
                    .sort()
                    .map(([letter, articles]) => (
                        ...
                        <div className="space-y-3">
                          {articles.map((article) => (
                            <div key={article.id} className="flex items-start">
                              ...
                              <div>
                                <p className="font-medium text-emprad-dark-purple">
                                  {article.title}
                                </p>
