...
const SmartSearch: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    const filteredResults = mockArticlesDatabase.filter(
      (article) =>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Busque entre os artigos cadastrados no EMPRAD
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border mb-6">
          ...
          {showFilters && (
            <div className="mt-4 border-t pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <h3 className="font-medium mb-2 text-emprad-dark-purple">
                  Ano de Publicação
                </h3>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-emprad-dark-purple">
